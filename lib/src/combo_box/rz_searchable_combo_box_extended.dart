...
class _RzSearchableComboBoxExtendedState<T>
  ...
  void initState() {
    ...
    final int init = _resolveIndex();
    if (init >= 0 && init < _allItems.length) {
      selectedIndex = init;
      _mainController.text = widget.labelBuilder(_allItems[init]);
    } else {
      selectedIndex = null;
    }
  ...
  @override
  void didUpdateWidget(covariant RzSearchableComboBoxExtended<T> oldWidget) {
